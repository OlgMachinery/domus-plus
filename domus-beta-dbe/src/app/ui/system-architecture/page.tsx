...
function SystemArchitecturePageInner() {
  ...
  // Modo compacto: altura fija = viewport menos header y padding del main (sin scroll)
  const diagramAreaHeight = 'calc(100vh - 25px - 4px - 8px)'
